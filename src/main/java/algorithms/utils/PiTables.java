...
public class PiTables {

    public static HashMap<String, Byte> getPI0() {
        HashMap<String, Byte> PI_0 = new HashMap<>();

        for (int i = 0; i < 256; i++) {
            PI_0.put(PiKeys[i], S0[i]);
        }

        return PI_0;
    }

    public static HashMap<String, Byte> getPI1() {
        HashMap<String, Byte> PI_1 = new HashMap<>();

        for (int i = 0; i < 256; i++) {
            PI_1.put(PiKeys[i], S1[i]);
        }

        return PI_1;
    }

    public static HashMap<String, Byte> getPI2() {
        HashMap<String, Byte> PI_2 = new HashMap<>();

        for (int i = 0; i < 256; i++) {
            PI_2.put(PiKeys[i], S2[i]);
        }

        return PI_2;
    }

    public static HashMap<String, Byte> getPI3() {
        HashMap<String, Byte> PI_3 = new HashMap<>();

        for (int i = 0; i < 256; i++) {
            PI_3.put(PiKeys[i], S3[i]);
        }

        return PI_3;
    }

    private static final String[] PiKeys = new String[]{
